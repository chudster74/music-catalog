...
/**
 * A generic ListModel class to support {@linkplain DnDList}. <p> The
 * DnDListModel acts as a wrapper around an internal list of items; providing
 * notification as the items are changed. </p>
 *
...
public class DnDListModel<T> extends AbstractListModel {
    ...
    /**
     * Get the list item at the specified index. <p> Note: this method returns a
     * live reference.
     *
    ...
    /**
     * Returns a list of the items at the specified indices. <p> Note: The
     * returned List contains live references.
     *
     ...
     *
     * @param destIndex the position of the new item: if &lt; 0 the item will be
     * inserted at the start of the list; if &gt;= the current list size the
     ...
     * be inserted at the start of the list; if &gt;= the current list size the
     * items will be appended to the end of the list
     */
     ...
     * {@code srcIndices} array as block such that they are inserted into the
     * list at {@code destIndex}. It is <b>assumed</b> that srcIndices is sorted
     * in ascending order.
     */
    ...
    /**
     * Removes the first instance of the specified item if it is contained in
     * the list
     */
    ...
    /**
     * Get the (first) index of the given item in the list of items held by this
     * model.
     *
