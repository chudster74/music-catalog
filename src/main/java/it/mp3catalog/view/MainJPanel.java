...
import it.mp3catalog.controller.PlayListItem;
import it.mp3catalog.controller.SongTableFormat;
import it.mp3catalog.model.HibernateUtil;
...
public class MainJPanel extends javax.swing.JPanel {
    ...
    private EventList<Song> songsEventList = new BasicEventList<Song>();
...
//        }); // end MouseMotionAdapter
    ...
    final void fillTableModel() {
        ...
        SortedList<Song> sortedSongs = new SortedList<Song>(songsEventList);
        MatcherEditor<Song> textMatcherEditor = new TextComponentMatcherEditor<Song>(searchTextField, new SongTextFilterator());
        FilterList<Song> textFilteredIssues = new FilterList<Song>(sortedSongs, textMatcherEditor);
