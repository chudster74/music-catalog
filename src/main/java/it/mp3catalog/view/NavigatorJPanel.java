...
import it.mp3catalog.controller.DnDList;
import it.mp3catalog.controller.DnDListModel;
...
public class NavigatorJPanel extends javax.swing.JPanel {
    ...
    public NavigatorJPanel(MainJFrame frame) {
        initComponents();
        this.frame = frame;
        list = new DnDList<PlayListItem>();
        list.setDragEnabled(true);
        list.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
        DnDListModel<PlayListItem> model = new DnDListModel<PlayListItem>();
        list.setModel(model);
